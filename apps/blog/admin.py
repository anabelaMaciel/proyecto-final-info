...
from .models import Categorias, Usuario_personalizado, Posts, Like_post, Comentarios, Like_comentario, Contacto
...
class PostAdmin(admin.ModelAdmin):
    list_display = ['fecha_creacion', 'usuario',
                    'categorias', 'subtitulo', 'titulo']


class Usuario_personalizadoAdmin(admin.ModelAdmin):
    list_display = ['fecha_registro', 'username',
